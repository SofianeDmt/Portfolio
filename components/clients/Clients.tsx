  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
        ...
        <h2 className="mb-8 lg:mb-16 text-xl font-bold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">
        ...
        <div className="justify-around flex text-gray-500 dark:text-gray-400 mt-10 flex-col md:flex-row lg:flex-row">
          <a href="#" className="flex justify-center items-center mt-10">
            <LogoAndromed className="h-9 bg-white rounded-sm" />
          </a>
        </div>
      </div>
    </section>
